...
= 1.1.2 =
* Updater: Reinforced package integrity guard, dynamic update row notification, and transient cooldown.
* Tests: Added comprehensive PHPUnit test suite for GitHub auto-updater lifecycles.
